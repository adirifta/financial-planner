import AlertAction from '@/components-test/AlertAction';
import BreadcrumbHeader from '@/components-test/BreadcrumbHeader';
import CardStat from '@/components-test/CardStat';
...
import HeaderTitle from '@/components-test/HeaderTitle';
import { Alert, AlertDescription, AlertTitle } from '@/components-test/ui/alert';
import { Button } from '@/components-test/ui/button';
import { Card, CardContent, CardFooter, CardHeader } from '@/components-test/ui/card';
import { Progress } from '@/components-test/ui/progress';
import { Table, TableBody, TableCell, TableHead, TableHeader, TableRow } from '@/components-test/ui/table';
    ...
    return (
        <div className="flex w-full flex-col gap-y-6 pb-32">
            ...
            <Alert variant={props.goal.balances_sum_amount >= props.goal.monthly_saving ? 'success' : 'destructive'}>
                <AlertTitle>
                    {props.goal.balances_sum_amount >= props.goal.monthly_saving ? 'Yeee....!!!' : 'Upps...!!!'}
                </AlertTitle>
                <AlertDescription>
